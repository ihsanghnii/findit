...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update database
    $update = $mysqli->prepare("UPDATE lost_items SET title = ?, description = ?, location_lost = ?, date_lost = ?, image_path = ? WHERE id = ?");
...
<head>
    <meta charset="UTF-8">
    <title>Edit Barang Hilang - FindIt</title>
...
<body>
    ...
    <div class="container py-4">
        <h2 class="mb-4">Edit Barang Hilang</h2>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="location" name="location" value="<?= htmlspecialchars($item['location_lost']) ?>" required>
            </div>
            <div class="mb-3">
                <label for="date" class="form-label">Tanggal Hilang</label>
                <input type="date" class="form-control" id="date" name="date" value="<?= htmlspecialchars($item['date_lost']) ?>" required>
            </div>
            <div class="mb-3">
