...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Simpan ke database
    $stmt = $mysqli->prepare("INSERT INTO found_items (user_id, title, description, location_found, date_found, image_path) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Tambah Barang Ditemukan - FindIt</title>
...
<body>
    ...
    <div class="container py-4">
        <h2 class="mb-4">Tambah Barang Ditemukan</h2>
